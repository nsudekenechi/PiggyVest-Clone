  ...
  return (
    <div>
      <header>
        ...
        <div className='flex overflow-auto gap-x-5 py-3 mb-10'>
        ...
        <div className="grid grid-cols-3 gap-x-10">
          <div className='col-span-2'>
            ...
            <div className='py-10'>
              <Link href={""} className='flex items-center rounded-t-xl rounded-br-xl rounded-bl-none  border-[#ccc] p-5 gap-x-5 cursor-pointer mb-5' style={{ color: 'rgb(13, 96, 216)', border: '1px solid' }}>
                <div >
                  <FiThumbsUp size={25} />
                </div>
                <div>
                  <p className='font-bold text-xs'>See your recent activities</p>
                  <p className='text-xs font-light text-black'>See your most  recent activities  on Piggyvest</p>
                </div>
              </Link>

              <Link href={""} className='flex items-center rounded-t-xl rounded-br-xl rounded-bl-none  border-[#ccc] p-5 gap-x-5 cursor-pointer mb-5' style={{ color: 'rgb(34, 149, 242)', border: '1px solid' }}>
                <div >
                  <HiLockClosed size={25} />
                </div>
                <div>
                  <p className='font-bold text-xs'>Create a safe lock</p>
                  <p className='text-xs font-light text-black'>See your most  recent activities  on Piggyvest</p>
                </div>
              </Link>

              <Link href={""} className='flex items-center rounded-t-xl rounded-br-xl rounded-bl-none  border-[#ccc] p-5 gap-x-5 cursor-pointer mb-5' style={{ color: 'rgb(117, 63, 246)', border: '1px solid' }}>
                <div >
                  <MdOutlineAlternateEmail size={25} />
                </div>
                <div>
                  <p className='font-bold text-xs'>Link your Pocket App</p>
